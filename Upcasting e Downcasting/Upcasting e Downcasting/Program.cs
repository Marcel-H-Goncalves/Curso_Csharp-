...
namespace Upcasting_e_Downcasting
{
    internal class Program
    {
        ...
        //Up - para cima 
        //casting - conversão
        //Resumido: é a conversão de um objeto da classe filha para um objeto da classe mãe

        //Downcasting = Conversão para baixo
        //Down - para baixo
        //casting - conversão
        //Resumindo: é a conversão de um objeto da classe mãe pra um objeto da classe filha 
