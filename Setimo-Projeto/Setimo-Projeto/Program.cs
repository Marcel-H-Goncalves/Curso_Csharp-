    ...
    internal class Program
    {
        ...
        public static Resultado_e CadastraUsuario(ref List<DadosCadastraisStruct> ListaDeUsuarios)
        {
            ...
            if (PegaData(ref cadastroUsuario.DataDeNascimento, "Digite a data de nascimento no formato DD/MM/AAAA ou digite S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
            if (PegaString(ref cadastroUsuario.NumeroDoDocumento, "Digite o numero do documento ou digite S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
            ...
            GravarDados(caminhoArquivo, ListaDeUsuarios);
            return Resultado_e.Sucesso;
        }

        public static void GravarDados(string caminho, List<DadosCadastraisStruct> ListaDeUsuarios)
        {
            try
            {
        ...
        static void Main(string[] args)
        {
            ...
            tagNumeroDeDocumento = "NUMERO_D0_DOCUMENTO : ";
