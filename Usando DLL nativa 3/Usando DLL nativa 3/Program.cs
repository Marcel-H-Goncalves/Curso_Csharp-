...
namespace Usando_DLL_nativa_3
{
    internal class CascaDLLNativa
    {
        ...
        [DllImport(@"C:\Users\marce\Downloads\Usando+DLL+nativa+1\3.4 Usando DLL nativa 1\Usando DLL nativa 1\DLL\DLL_Nativa.dll", CallingConvention = CallingConvention.Cdecl)]
