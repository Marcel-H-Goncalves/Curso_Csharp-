...
namespace Listas
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Adicionar elementos
            ListaDeNomes.Add("Marcel");
            ListaDeNomes.Add("Yasmin");
            ListaDeNomes.Add("Regilaine");
            ...
            ListaDeNomes2.RemoveRange(1, 2); //1 a partir de qual indice 2 quando itens a partir do indice
            ...
            //Descobrindo o indice de um elemento
            ...
            //serve para pegar quais nomes começam com M       onde        que começam com m   cria uma lista 
