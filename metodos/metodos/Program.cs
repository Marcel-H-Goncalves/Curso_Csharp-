...
namespace metodos
{
    ...
    {
        //tipo_de_acesso modificador_de_instancia tipo_de_retorno nome_de_metodo(parametros_de_entrada)
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("O resultado da soma de " + numero1 + " mais " + numero2 + " resulta em: ");
